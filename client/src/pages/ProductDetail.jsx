...
export default function ProductDetail({ setProductos }) {
  const { id } = useParams();
  ...
  if (!producto)
    return <p style={{ textAlign: "center" }}>No se encontró el producto.</p>;

  const atributosExcluidos = [
    "_id",
    "nombre",
    "descripcion",
    "img",
  ...
  return (
    <section id="producto-container">
      <div className="product-img">
        <img
          src={`https://proyecto-muebleria-hnos-j-1.onrender.com/${producto.img}`}
